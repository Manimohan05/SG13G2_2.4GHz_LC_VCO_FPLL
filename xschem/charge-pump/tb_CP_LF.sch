...
N 1340 -550 1340 -530 {lab=GND}
N 1340 -550 1380 -550 {lab=GND}
N 1530 -560 1570 -560 {lab=CTRL}
N 1380 -550 1380 -530 {lab=GND}
N 1380 -560 1380 -550 {lab=GND}
N 1220 -440 1220 -420 {lab=GND}
...
write tb_CP_LF_tran.raw v(UP) v(DN) v(VCP) v(CTRL)
...
C {gnd.sym} 1340 -530 0 0 {name=l2 lab=GND}
C {gnd.sym} 1220 -420 0 0 {name=l4 lab=GND}
C {xschem/charge-pump/CHARGE_PUMP.sym} 1180 -590 0 0 {name=x1}
C {xschem/loop-filter/LOOP_FILTER.sym} 1460 -560 0 0 {name=x2}
