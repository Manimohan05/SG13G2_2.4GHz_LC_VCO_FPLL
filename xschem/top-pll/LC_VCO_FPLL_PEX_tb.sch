...
xpll.clk_fb"
x1=60e-06
rawfile=$netlist_dir/tb_LC_VCO_FPLL_PEX_40u.raw}
...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_LC_VCO_FPLL_PEX_40u.raw tran
"
}
...
xschem netlist; 
xschem simulate; 
xschem raw_read $netlist_dir/tb_LC_VCO_FPLL_PEX_40u.raw tran; 
xschem redraw
"}
C {vdd.sym} 740 -730 0 0 {name=l3 lab=VDD}
...
.ic v(xpll.outp)=0.4
* extracted (Magic RC) netlists of every block; the inductor is the EM model
...
.control
  * CRITICAL: Save ONLY essential low-frequency signals. 
  save xpll.vctrl xpll.up xpll.dn xpll.clk_fb clk_out clk_in vbgr xpll.vcp xpll.outp sdata sclk en rst
  ...
  * 20p defines the step to resolve the 2.4 GHz edges without forcing a maxstep.
  ...
  remzerovec
  write tb_LC_VCO_FPLL_PEX_40u.raw 
.endc
"}
...
C {xschem/top-pll/LC_VCO_FPLL_PEX.sym} 710 -590 0 0 {name=xpll}
...
C {vdd.sym} 790 -730 0 0 {name=l6 lab=GND}
