...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_LC_VCO_FPLL_40u.raw tran
"
}
...
xschem netlist; 
xschem simulate; 
xschem raw_read $netlist_dir/tb_LC_VCO_FPLL_40u.raw tran; 
xschem redraw
"}
...
C {xschem/top-pll/LC_VCO_FPLL.sym} 710 -590 0 0 {name=xpll}
