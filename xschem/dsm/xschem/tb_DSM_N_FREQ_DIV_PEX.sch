...
F {}
E {}
B 2 170 -600 1330 -390 {flags=graph
y1=0
y2=3
ypos1=-0.15
ypos2=2.85
...
N 710 -60 750 -60 {lab=en}
N 710 -80 750 -80 {lab=sdata}
N 710 -100 750 -100 {lab=sclk}
N 710 -120 750 -120 {lab=rst}
N 560 -270 560 -240 {lab=freq_in}
...
N 480 -185 480 -145 {lab=GND}
N 480 -285 480 -245 {lab=VDD}
N 850 -355 850 -315 {lab=VDD}
N 850 -115 850 -75 {lab=GND}
C {simulator_commands.sym} 160 -330 0 0 {name=SimulatorNGSPICE
simulator=ngspice
only_toplevel=false 
value="
.param temp = 27
...
"}
C {launcher.sym} 420 -370 0 0 {name=h5
descr="load waves" 
...
C {lab_pin.sym} 710 -80 0 0 {name=p7 sig_type=std_logic lab=sdata}
C {lab_pin.sym} 710 -100 0 0 {name=p8 sig_type=std_logic lab=sclk}
C {lab_pin.sym} 710 -120 0 0 {name=p9 sig_type=std_logic lab=rst}
C {noconn.sym} 750 -120 2 0 {name=l2}
C {noconn.sym} 750 -100 2 0 {name=l3}
C {noconn.sym} 750 -80 2 0 {name=l4}
C {noconn.sym} 750 -60 2 0 {name=l5}
...
C {vsource.sym} 480 -215 0 0 {name=V2 value="1.2" savecurrent=false}
C {gnd.sym} 480 -145 0 0 {name=l6 lab=GND}
C {vdd.sym} 480 -285 0 0 {name=l7 lab=VDD}
...
C {code.sym} 150 -190 0 0 {name=STD_CELLS only_toplevel=false
value="
************************************************************************
